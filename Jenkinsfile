                        ...
                        script {
                            ...
                            sequences = [
                                [description: 'run_if_pr=true',
                                 kwargs: [tags: 'pr', pragma_suffix: '-hw-medium', distro: null, run_if_pr: true, run_if_landing: true],
                                 pragma: '',
                                 expect: false],
                                [description: 'run_if_pr=false',
                                 kwargs: [tags: 'pr', pragma_suffix: '-hw-medium', distro: null, run_if_pr: false, run_if_landing: true],
                                 pragma: '',
                                 expect: true],
                                [description: 'Distro set',
                                 kwargs: [tags: 'pr', pragma_suffix: '-hw-medium', distro: 'el8', run_if_pr: true, run_if_landing: true],
                                 pragma: '',
                                 expect: false],
